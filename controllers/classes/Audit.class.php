...
class Audit {
    ...
    public function create_audit_request($f_name,$l_name,$phone_no,$email,$s_lga,$street_address,$b_date,$b_time,$created_on){
        $query = "INSERT INTO tbl_audit_booking SET first_name=?,last_name=?,phone_no=?,email=?,lga=?,address=?,b_date=?,b_time=?,b_created_on=?";
        $inserted_obj = $this->conn->prepare($query);
        $inserted_obj->bind_param("sssssssss",$f_name,$l_name,$phone_no,$email,$s_lga,$street_address,$b_date,$b_time,$created_on);
    ...
    public function send_audit_booking_mail($id){
        ...
        if ($aud_obj->execute()){
            ...
            $body = ['Messages' => [[
                ...
                <p style='margin: 0; font-size: 14px; text-align: center;'>Hi ".$data['first_name'].", this is a confirmation that we’ve just received your online payment for Solar Audit
                 <span id='166c679c-c52f-47e0-ab65-2830067c661d' style=''>@ ".$data['address'].", ".$data['lga']."</span>. Thank you for trusting us. Our esteem team will reach out to you shortly</p>
                </div>
                </div>
                </td>
                </tr>
                ...
                <tr>
                <td style='padding:0 10px 0 10px;'><a href='https://www.facebook.com/' target='_blank'><img alt='Facebook' height='32' src='https://i.ibb.co/JcxsdJ3/facebook2x.png' style='display: block; height: auto; border: 0;' title='Facebook' width='32'/></a></td>
                <td style='padding:0 10px 0 10px;'><a href='https://twitter.com/' target='_blank'><img alt='Twitter' height='32' src='https://i.ibb.co/cxjFVNH/twitter2x.png' style='display: block; height: auto; border: 0;' title='Twitter' width='32'/></a></td>
                </tr>
                </table>
                </td>
                </tr>
